...
new InternNotifsStack(app, 'InternNotifs', { env: { region: app.node.tryGetContext('region') || 'us-east-1' }, githubRepository, emailAddress, existingOidcProviderArn: app.node.tryGetContext('existingOidcProviderArn') });
