...
- [ ] Close the Ashby emergency-promotion follow-up: the 2026-08-10 review found 28 healthy published boards with 24-hour clean-run, link, queue, and quiet-baseline evidence. Base Power, Circleback, Heliux, OpusClip, Pylon, Quadrillion, and Yotta are quarantined pending refreshed first-party ownership evidence and clean recovery validation; then commit normal promotion evidence and retire the temporary override records.
