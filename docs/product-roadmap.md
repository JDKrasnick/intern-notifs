...
- [ ] Complete issue #134's employer metadata enrichment rollout.
  ...
  - [ ] Recollect v12 evidence, finish unresolved provider/housing review, obtain exact repair approvals and rescore the published feed. See [the delivery plan](metadata-coverage-plan.md).
