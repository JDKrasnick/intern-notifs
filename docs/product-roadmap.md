...
- [x] Complete Sentry's normal promotion observation follow-up using clean Cloudflare runs through 2026-08-26T18:03:06Z and remove the temporary observation-window override.
- [x] Manually verify and publish Verkada through Greenhouse and The Voleon Group through its current Ashby board; both passed live identity/schema, technical early-career role, standard-host, and application-link checks on 2026-08-26.
- [ ] Complete Voleon's normal promotion observation follow-up after 2026-08-27T16:20:00Z and remove the temporary observation-window override.
- [x] Manually verify and publish Maximor AI through its current Ashby board, including explicit owner approval for its first-party site having no current careers link; live schema, technical early-career role, standard-host, and application-link checks passed on 2026-08-26.
- [ ] Complete Maximor's normal promotion observation follow-up after 2026-08-27T16:25:00Z and remove the temporary observation-window override.
