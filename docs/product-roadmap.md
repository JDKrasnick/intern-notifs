...
- [x] Add job freshness and official/community provenance labels to role details and every catalog or saved-role card across mobile and responsive web, plus filter-match explanations, hybrid New status, and duplicate-safe notification deep links, including closed and unavailable states.
