...
- [ ] Validate Gmail connect, cancellation, initial sync, incremental sync, review, disconnect, and account deletion with OAuth-console test users and representative real confirmations.
