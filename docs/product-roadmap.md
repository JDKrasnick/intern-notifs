...
- [ ] Complete issue #134's employer metadata enrichment rollout.
  ...
  - [ ] Recollect v13 evidence, finish unresolved provider review, obtain exact repair approvals and rescore the published feed. See [the delivery plan](metadata-coverage-plan.md).
