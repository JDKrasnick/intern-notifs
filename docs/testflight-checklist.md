...
- Open Privacy Policy and Support in Profile. Verify account deletion removes the signed-in user’s profile, applications, documents, Cloudflare sessions, and sign-in identity while leaving device alerts and app settings intact.
