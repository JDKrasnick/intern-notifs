...
const listing: RawListing = { sourceId: 'fixture', document: 'README.md', sourceUrl: 'https://example.com', row: 1, company: 'Acme', title: 'Software Engineering Intern', location: 'Remote', season: 'summer-2027', applyUrl: 'https://example.com/apply', compensation: { raw: '' }, state: 'open', fetchedAt: '2026-01-01T00:00:00Z' };
